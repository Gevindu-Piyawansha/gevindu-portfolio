...
function Hero() {
    ...
    const handleSubmit = (e) => {
        ...
        emailjs.send(
            'service_q8mxbzq',    // 👈 replace with your EmailJS service ID
            'template_coyg85x',   // 👈 replace with your EmailJS template ID
            {
                from_name: name,
                from_email: email,
                message: message,
            },
            '73jkaxIQjcnGN8pWm'     // 👈 replace with your EmailJS public key
        )
            .then(() => {
                alert('Message sent!');
