...
function Hero({ isContactModalOpen, setIsContactModalOpen }) {
  ...
  const stats = [
    { label: "Years BIM Experience", value: "4+" },
    { label: "BIM Projects", value: "5+" },
    { label: "AEC Tools", value: "10+" },
  ];
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col justify-center items-center md:items-center text-center md:text-center w-full md:w-1/2 space-y-6 -mt-6 md:mt-0 ">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-blue-700 leading-normal">
            Gevindu Piyawansha
          </h1>

          <h2 className="text-lg sm:text-xl lg:text-2xl text-gray-700 font-medium min-h-[2rem] flex items-center justify-center">
            {displayText}
            <span className="inline-block w-0.5 h-6 bg-teal-600 ml-1 animate-pulse"></span>
          </h2>

          <p className="text-base sm:text-lg text-gray-600 max-w-2xl text-center">
            Bridging civil engineering expertise and digital technology through
            BIM. Delivering coordinated 3D models, clash detection, and
            data-driven workflows for smarter construction.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-center">
            <button
              ...
              className="px-6 sm:px-8 py-3 rounded-full bg-gradient-to-r from-teal-600 to-blue-700 text-white font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-200 shadow-md"
            >
              View BIM Projects
            </button>
            ...
            <button
              ...
              className="
                                ...
                                border-2 border-blue-700 text-blue-700 font-semibold
                                bg-white
                                hover:bg-gradient-to-r hover:from-teal-600 hover:to-blue-700 hover:text-white hover:border-transparent
          ...
          <div className="flex gap-6 justify-center md:justify-center mt-8">
            <a
              ...
              className="w-12 h-12 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center text-gray-700 hover:text-teal-600 hover:scale-110 transition-all duration-200 shadow-md hover:shadow-lg"
        ...
        <div className="w-full md:w-1/2 flex justify-center items-center relative px-6 mt-8 md:mt-0 ">
          <div className="relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-teal-600 to-blue-700 rounded-full blur opacity-25 group-hover:opacity-75 transition duration-1000 group-hover:duration-200 animate-pulse"></div>
            <img
              src="/profile.jpg"
      ...
      <div className="flex justify-center mt-10">
        <button
          ...
          className="
            w-12 h-6 rounded-full bg-white/80 backdrop-blur-sm flex items-center justify-center text-gray-700 hover:bg-gradient-to-r hover:from-teal-600 hover:to-blue-700 hover:text-white transition-all duration-300 shadow-sm animate-bounce"
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button
                  ...
                  className="
                                        px-4 py-2 rounded 
                                        bg-gradient-to-r from-teal-600 to-blue-700 text-white font-semibold 
