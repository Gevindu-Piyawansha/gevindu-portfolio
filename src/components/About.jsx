...
function About() {
    return (
        <section id="about" className="py-16 sm:py-20 lg:py-24 bg-white scroll-mt-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12 sm:mb-16">
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-800 mb-4">About</h2>
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start justify-items-center">
                    ...
                    <div className="order-2 lg:order-1 flex justify-center">
                        <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 sm:p-8 rounded-2xl shadow-lg max-w-md">
                            ...
                            <p className="text-gray-700 leading-relaxed mb-6 text-sm sm:text-base">
                                I’m a full-stack developer with strong Java backend skills and frontend expertise in React.
                                I focus on building reliable, user-friendly applications while continuously improving my
