          ...
          <div className="order-2 lg:order-1">
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 sm:p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-sm sm:text-base">
                ...
                wastewater & Water treatment & design infrastructures like National Water Supply and Drainage Board, Sri Lanka. I'm also learning to build full-stack applications
